...
Verification: the security/results/{DATE}.md file exists with all findings severity-classified, each tool has a non-empty output in security/{tool}/{DATE}.md, and zero Critical findings remain after remediation.
